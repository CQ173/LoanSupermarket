...
import com.hackerfj.loansupermarket.util.ScreenUtils;
import com.hackerfj.loansupermarket.util.Utility;
...
public class PieChartView extends View {
    ...
    private int[] mPieColors = new int[]{Color.RED, Color.GREEN, Color.BLUE, Color.YELLOW, Color.MAGENTA, Color.CYAN, Color.LTGRAY, Color.BLACK};
    ...
    private void init(Context context) {
        ...
        textPaint.setTextSize(ScreenUtils.dp2px(context, 10));
